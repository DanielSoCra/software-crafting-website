...
export const projects: Project[] = [
  {
    ...
    solution: "Eine immersive E-Commerce-Plattform mit integriertem 3D-Konfigurator. Kunden können Möbel in fotorealistischer Qualität betrachten und in ihrem eigenen Raum visualisieren. Das responsive Design sorgt für ein nahtloses Einkaufserlebnis auf allen Geräten.",
    results: [
  ...
  },
  {
    ...
    longDesc: "Die FinVest Group brauchte eine Markenidentität, die Vertrauen und Innovation gleichermaßen ausstrahlt. Das Ergebnis: ein komplettes Branding-System und eine digitale Plattform, die komplexe Finanzprodukte verständlich und zugänglich macht. Die neue Plattform hat die Nutzer-Registrierungen um 250% gesteigert.",
    ...
    solution: "Eine Markenidentität, die Seriosität mit Innovation verbindet. Die neu gestaltete Plattform macht komplexe Finanzinformationen durch klare Visualisierungen und intuitive Navigation zugänglich. Ein durchgängiges Design-System sorgt für Konsistenz.",
    results: [
  ...
  },
  {
    ...
    longDesc: "GreenTech Solutions hatte großartige Produkte, aber keine Sichtbarkeit. Durch eine kombinierte Strategie aus technischem SEO, AI Search Optimization und strategischem Content-Marketing stieg die organische Reichweite um 340% — und die Marke wurde als Thought Leader in der Branche positioniert.",
    ...
    solution: "Eine ganzheitliche SEO-Strategie: technische Optimierung, semantische Content-Architektur und AI Search Optimization. Ein redaktioneller Content-Plan mit Fachartikeln positionierte GreenTech als Branchenexperten.",
    results: [
